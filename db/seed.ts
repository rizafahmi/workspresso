...
export default async function seed() {
  ...
  await db.insert(Venue).values({
    ...
    tags: "coffee shop,traditional,wifi,meetings,casual,downtown",
    grade: "B",
    wifiScore: 4,
    powerScore: 3,
    noiseScore: 3,
  ...
  await db.insert(Venue).values({
    ...
    tags: "coworking,programmers,tech,startup,standing desks,premium,ultra fast wifi",
    grade: "A",
    wifiScore: 5,
    powerScore: 5,
    noiseScore: 5,
  ...
  await db.insert(Venue).values({
    ...
    tags: "neighborhood,busy,social,coffee,limited amenities",
    grade: "C",
    wifiScore: 2,
    powerScore: 2,
    noiseScore: 2,
